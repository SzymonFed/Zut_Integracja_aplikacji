 ...
 * 
 */
@WebServiceClient(name = "BookManagerService", targetNamespace = "http://books/", wsdlLocation = "http://localhost:666/books?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKMANAGERSERVICE_QNAME = new QName("http://books/", "BookManagerService");
    ...
    public BookManager getBookManagerPort() {
        return super.getPort(new QName("http://books/", "BookManagerPort"), BookManager.class);
    }
    ...
    public BookManager getBookManagerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://books/", "BookManagerPort"), BookManager.class, features);
    }
